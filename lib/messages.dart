...
import 'package:fitapp/search.dart';
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            ...
            Spacer(),
            IconButton(
              icon: Image.asset('assets/more.png', height: 50),
              onPressed: () {},
            ),
          ],
        ),
...
class ActivitySection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          Image.asset('assets/cycling.png', height: 60),
          SizedBox(width: 10),
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
          ...
          Row(
            children: [
              Image.asset('assets/streak.png', height: 30),
              SizedBox(width: 5),
              Text(
                '1282 Kcal',
